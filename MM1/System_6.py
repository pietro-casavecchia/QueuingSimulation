...
out_IA = round(np.mean(array_IA), 2)
out_S = round(np.mean(array_S), 2)
out_Lambda = round(np.mean(array_Lambda), 2)
out_Mu = round(np.mean(array_Mu), 2)
out_Rho = round(np.mean(array_Rho), 2)
out_Ls = round(np.mean(array_Ls), 2)
out_Lq = round(np.mean(array_Lq), 2)
out_Ws = round(np.mean(array_Ws), 2)
out_Wq = round(np.mean(array_Wq), 2)
out_P0 = round(np.mean(array_P0), 2)
...
print("Lambda theo: {} Lambda out: {} error: {}".format(round(Lambda_theo, 2), out_Lambda, error_Lambda))
print("Mu theo: {} Mu out: {} error: {}".format(round(Mu_theo, 2), out_Mu, error_Mu))
print("Rho theo: {} Rho out: {} error: {}".format(round(Rho_theo, 2), out_Rho, error_Rho))
print("Ls theo: {} Ls out: {} error: {}".format(round(Ls_theo, 2), out_Ls, error_Ls))
print("Lq theo: {} Lq out: {} error: {}".format(round(Lq_theo, 2), out_Lq, error_Lq))
print("Ws theo: {} Ws out: {} error: {}".format(round(Ws_theo, 2), out_Ws, error_Ws))
print("Wq theo: {} Wq out: {} error: {}".format(round(Wq_theo, 2), out_Wq, error_Wq))
print("P0 theo: {} P0 out: {} error: {}".format(round(P0_theo, 2), out_P0, error_P0))
