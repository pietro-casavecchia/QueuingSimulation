...
for i in range(n_experiments):
    ...
    P0 = array_P0[0] / (array_P0[0] + array_P0[1])
...
avg_exp_Ls = np.mean(array_Ls)
avg_exp_plot_Ls = []
for i in range(len(experiment_no)):
    avg_exp_plot_Ls.append(avg_exp_Ls)

# plot of Ls in function of experiment 
plt.plot(experiment_no, array_Ls, color=(0, 0, 0), linewidth=1.0)
plt.plot(experiment_no, avg_exp_plot_Ls, color=(0, 0, 0), linewidth=1.0)
plt.grid(linewidth = 0.5)
plt.show()